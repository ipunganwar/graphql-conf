...
async function tambahSiswaSatuSekolahTerdaftar (level_user, kode_sekolah, idSekolahYgMauDicari, dataYgAkanDiinput) {
  if (level_user === 0 || kode_sekolah.indexOf(idSekolahYgMauDicari) > -1) {
    if (!dataYgAkanDiinput.email || !dataYgAkanDiinput.id || !dataYgAkanDiinput.alamat || !dataYgAkanDiinput.email || !dataYgAkanDiinput.kelas || !dataYgAkanDiinput.nisn || !dataYgAkanDiinput.password || !dataYgAkanDiinput.foto || !dataYgAkanDiinput.nama || !dataYgAkanDiinput.peran) {
      return {
      ...
      try {
        let pelangganBaru = await Pelanggan.create({
          ...
          kelas: dataYgAkanDiinput.kelas,
          username: dataYgAkanDiinput.nisn,
        ...
        console.log('/src/controllers/manajemenUser/sekolahTerdaftar/tambahSiswaSatuSekolahTerdaftar/:40', e);
        return {
...
module.exports = tambahSiswaSatuSekolahTerdaftar;
