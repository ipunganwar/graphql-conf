...
async function ubahStaffSatuSekolahTerdaftar (level_user, kode_sekolah, idSekolahYgMauDicari, data) {
  if (level_user === 0 || kode_sekolah.indexOf(idSekolahYgMauDicari) > -1) {
    ...
    try {
      ...
      console.log('/src/controllers/manajemenUser/sekolahTerdaftar/ubahStaffSatuSekolahTerdaftar/:47', e);
      return {
...
module.exports = ubahStaffSatuSekolahTerdaftar;
